        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-800">TimeSaber</h3>
                <p className="text-xs text-gray-500">Carry Style, Carry Confidence</p>
              </div>
            </div>
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              TimeSaber brings you a curated collection of stylish and functional bags for every occasion. Shop with ease, style with confidence.            </p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="/womenwatch" className="text-gray-600 hover:text-gray-800 transition-colors text-sm">Women Bags</a>
              </li>
              <li>
                <a href="/menwatch" className="text-gray-600 hover:text-gray-800 transition-colors text-sm">Men Bags</a>
              </li>
              <li>
                <a href="/ourfavorites" className="text-gray-600 hover:text-gray-800 transition-colors text-sm">School Bags</a>
              </li>
              <li>
