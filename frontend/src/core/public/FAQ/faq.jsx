...
const FAQ = () => {
  ...
  const faqData = [
    ...
    {
      category: 'shopping',
      question: 'Are TimeSaber watches authentic luxury items?',
      answer: 'Yes, all bags listed under luxury brand categories  are 100% authentic. We have strict authentication processes and work only with verified suppliers. Each luxury item comes with authenticity certificates and our authenticity guarantee.'
    },
    {
      category: 'shopping',
    ...
    },
    {
      ...
      answer: 'Yes! Our TimeSaber Rewards program offers points for every purchase, exclusive member discounts, early access to sales, and birthday rewards. You earn 1 point per dollar spent, and 100 points = $5 in rewards. Join free when you create an account.'
    }
  ];
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600">Find answers to common questions about TimeSaber</p>
          </div>
        </div>
      </div>
        ...
        <div className="mt-16 bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-purple-600 font-medium">timesaber@gmail.com</p>
            </div>
          </div>
        </div>
