    ...
    <div>
      ...
      <div className="pt-32 bg-gray-200 h-full overflow-auto">
        <div className="flex items-center justify-center mb-8 ">
          ...
          <Typography className="mx-14 text-2xl font-semibold">Watch for women</Typography>
          <div className="border-t border-gray-400 w-24"></div>
        </div>
...
export const Babycare = () => {
  ...
  <div className="w-[100px]" />
      ...
      <div className="grid grid-rows-1 sm:grid-cols-2 lg:grid-cols-5 gap-1 py-8">
        {randomProducts.map((product) => (
          ...
          >
            ...
            <CardFooter className="pt-4 pb-4 px-11 flex">
              <Button
                ripple={false}
                fullWidth={true}
                className="bg-[#D72638] py-0 rounded-r text-white shadow-md hover:scale-105 transition-transform duration-200 hover:bg-green-300 hover:text-black"
      ...
      {selectedProduct && (
        <Dialog open={openModal} handler={handleCloseModal} className="max-w-lg">
          ...
          <DialogFooter className="flex gap-4">
            ...
            <Button
              className="bg-[#cc2637] rounded-2xl text-white  hover:bg-green-300 hover:text-black hover:scale-105 transition-transform duration-200"
              onClick={() => handleBuyNow(selectedProduct._id)}
              disabled={isAddingToCart}
            >
              <ShoppingBagOutlined />
